...
class HorizontalVerticalViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        let a = LinearView()
        a.layout(.vertical).views(map([#colorLiteral(red: 0.5254901961, green: 0.4588235294, blue: 0.662745098, alpha: 1), #colorLiteral(red: 0.7647058824, green: 0.6823529412, blue: 0.8392156863, alpha: 1), #colorLiteral(red: 0.937254902, green: 0.7333333333, blue: 0.8117647059, alpha: 1), #colorLiteral(red: 1, green: 0.8352941176, blue: 0.8039215686, alpha: 1)])).done()
